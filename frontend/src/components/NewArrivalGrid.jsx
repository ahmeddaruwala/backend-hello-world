import img1 from "../assets/home-page-images/ps5.png"
import img2 from "../assets/home-page-images/woman.png"
import img3 from "../assets/home-page-images/speakers.png"
import img4 from "../assets/home-page-images/perfumes.png"
    ...
    <div className="main grid grid-cols-4 gap-8 grid-rows-2">
      ...
      <div className="bg-black">
        ...
        >
          ...
          <div className="absolute gap-2 flex-col flex bottom-0 p-6">
            <h3 className="S_Underline font-semibold text-2xl">Perfume</h3>
